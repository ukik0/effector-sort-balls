...
export const InPlay: React.FC = () => {
    ...
    const tubes = useList($fields, {
        fn: ({balls, over, complete}, index) => <Tube
            tube={{ balls, over, complete: complete}}
            position={index}
            onClick={tubeClicked}
        />
    })
...
const BallComponent: React.FC<{ ball: BallColor; className?: string, children?: ReactNode }> = ({
                                                                              className,
                                                                              children,
                                                                              ball,
                                                                          }) => (
